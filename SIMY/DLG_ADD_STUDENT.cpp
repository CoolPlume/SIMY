...
IMPLEMENT_DYNAMIC(DLG_ADD_STUDENT, CDialogEx)

DLG_ADD_STUDENT::DLG_ADD_STUDENT(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_ADD_STUDENT, pParent)
{

}

DLG_ADD_STUDENT::~DLG_ADD_STUDENT()
{
}

void DLG_ADD_STUDENT::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(DLG_ADD_STUDENT, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON1, &DLG_ADD_STUDENT::OnBnClickedButton1)
END_MESSAGE_MAP()


// DLG_ADD_STUDENT 消息处理程序


BOOL DLG_ADD_STUDENT::OnInitDialog()
{
...
void DLG_ADD_STUDENT::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	const auto app = dynamic_cast<CSIMYApp*>(AfxGetApp());
	...
	stu.change_gender(gender_number);
	
	app->SIM->add_student(stu);
